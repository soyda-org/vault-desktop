...
class VaultWorkspaceView(QWidget):
    def __init__(
        ...
        *,
        ...
        workspace_nav_band = QFrame()
        workspace_nav_band.setObjectName("workspaceBand")
        workspace_nav_band.setProperty("bandRole", "header")
        workspace_nav_band_layout = QVBoxLayout(workspace_nav_band)
        workspace_nav_band_layout.setContentsMargins(0, 0, 0, 4)
        workspace_nav_band_layout.setSpacing(0)
        workspace_nav_band_layout.addLayout(workspace_nav_row)
        workspace_layout.addWidget(workspace_nav_band, 0)
        ...
        workspace_footer_row.setSpacing(12)
        workspace_footer_row.addWidget(preference_widgets["keep_open"], 0)
        workspace_footer_row.addStretch(1)
        workspace_footer_row.addWidget(preference_widgets["session_identity"], 0)
        workspace_footer_row.addStretch(1)
        ...
        workspace_footer_band = QFrame()
        workspace_footer_band.setObjectName("workspaceBand")
        workspace_footer_band.setProperty("bandRole", "footer")
        workspace_footer_band_layout = QVBoxLayout(workspace_footer_band)
        workspace_footer_band_layout.setContentsMargins(0, 10, 0, 0)
        workspace_footer_band_layout.setSpacing(0)
        workspace_footer_band_layout.addLayout(workspace_footer_row)
        workspace_layout.addWidget(workspace_footer_band, 0)
